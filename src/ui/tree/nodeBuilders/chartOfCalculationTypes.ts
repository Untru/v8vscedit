...
// ---------------------------------------------------------------------------
// Объект «План видов расчёта» (ChartOfCalculationTypes).
// Папка: ChartsOfCalculationTypes. Дескриптор — nodes/objects/ChartOfCalculationTypes.ts.
// ---------------------------------------------------------------------------

const NODE_KIND = 'ChartOfCalculationTypes' as const;

export const chartOfCalculationTypesHandler: ObjectHandler = {
