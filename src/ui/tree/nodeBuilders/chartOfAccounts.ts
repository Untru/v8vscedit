...
// ---------------------------------------------------------------------------
// Объект «План счетов» (ChartOfAccounts). Папка: ChartsOfAccounts.
// Дескриптор — nodes/objects/ChartOfAccounts.ts.
// ---------------------------------------------------------------------------

const NODE_KIND = 'ChartOfAccounts' as const;

export const chartOfAccountsHandler: ObjectHandler = {
